<template>
  <div class="city-select flex width100 jc-sb">
    <select v-model="selectedProvince" name="province" class="select marginR20 border color86">
    ...
    <select v-model="selectedCity" name="city" class="select marginR20 border color86">
    ...
    <select v-model="selectedBlock" name="block" class="select border color86">
 ...
 *  省 市 区/县城  三联动选择器
*/
import provinces from '../assets/js/city.js'
export default {
  name: 'app',
  created () {
  },
